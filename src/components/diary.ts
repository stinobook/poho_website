...
@customElement('diary-element')
export class DiaryElement extends LiteElement {
  @property()
  accessor image
  ...
  _renderImage() {
    ...
    if (typeof this.image === 'string') {
      ...
      return html`<div class="img"> ${this.image.map((img) => html` <img loading="lazy" src=${img} />`)}</div>`
    }
  }
